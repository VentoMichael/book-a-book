...
@section('content')
    <div class="relative">
        ...
        <form method="POST" action="{{route('books.index')}}" class="sm:gap-12 sm:grid sm:grid-cols-2" enctype="multipart/form-data">
            @csrf
            ...
            <div class="field my-6 flex flex-col sm:self-end sm:mb-0">
                ...
                <input id="title" name="title" required type="text" class="border rounded-lg p-3 pb-2 input @error('title')is danger @enderror"
                       value="{{ old('title') }}">
            ...
            <div class="field my-6 flex flex-col">
                ...
                <select name="orientation" required class="border rounded-lg p-3 input @error('orientation')is danger @enderror" id="orientation">
            ...
            <div class="field my-6 flex flex-col">
                ...
                <textarea name="presentation" class="border rounded-md p-3 pb-2 h-32" id="presentation">{{ old('presentation') }}</textarea>
            ...
            <div class="field my-6 flex flex-col">
                ...
                <input name="public_price" required value="{{ old('public_price') }}"
                       class="border rounded-lg p-3 pb-2 input @error('public_price')is danger @enderror" id="public_price" type="number">
            ...
            <div class="field my-6 flex flex-col">
                ...
                <input name="proposed_price" required class="border rounded-lg p-3 pb-2 input @error('proposed_price')is danger @enderror"
            ...
            <div class="field my-6 flex flex-col">
                ...
                <input name="stock" required class="border rounded-lg p-3 pb-2 input @error('stock')is danger @enderror" value="{{ old('stock') }}"
                       id="stock" type="number">
                @if($errors->first('stock'))<p class="text-red-500 text-lg mb-4">{{$errors->first('stock')}}</p>@endif
            </div>
                <button class="w-full rounded-xl mt-6 p-3 border hover:bg-orange-900 hover:text-white">Sauvegarder ce livre</button>
                <button class="w-full rounded-xl mt-6 bg-orange-900 text-white p-3" type="submit">Créer un nouveau livre</button>
        </form>
    </div>
@endsection
